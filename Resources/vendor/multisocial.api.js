...
exports.create = function(settings) {
	var site = (settings.site || "twitter").toLowerCase(), adapter = new OAuthAdapter(settings.consumerSecret, settings.consumerKey, "HMAC-SHA1", settings.site);
	...
	return urls == null ? (alert("The Social.js module does not support " + site + " yet!"), null) : {
		...
		getUserXING : function(_options, _callback) {
			this.authorize(function() {
				adapter.Api({
